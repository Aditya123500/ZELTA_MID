...
import os
import sys
os.chdir(r'C:\Users\aditya\Desktop\inter-iit\untrade-sdk')
...
def strat(strat1,strat2,strat3,strat4):
    ...
    master.to_csv(r'C:\Users\aditya\Desktop\inter-iit\master_eth.csv')
    eth_4h = pd.read_csv(r'C:\Users\aditya\Desktop\inter-iit\eth_4h.csv')
    ...
    eth_4h.to_csv(r'C:\Users\aditya\Desktop\inter-iit\eth_final.csv')
...
if __name__ == "__main__":
    ...
    strat1,strat2,strat3,strat4 = process_data(r'C:\Users\aditya\Desktop\inter-iit\eth_4h.csv',r'C:\Users\aditya\Desktop\inter-iit\eth_1D.csv')
    strat(strat1,strat2,strat3,strat4)
    perform_backtest(r'C:\Users\\Desktop\aditya\inter-iit\eth_final.csv')